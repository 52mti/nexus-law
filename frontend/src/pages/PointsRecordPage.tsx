      ...
      try {
        ...
        if (res?.successful && res?.data) {
          ...
          const formattedRecords: PointRecord[] = rawRecords.map((item: any) => {
            ...
            return {
              id: item.id,
              title: item.pointsType || item.changeType || '积分变动', // 优先用 pointsType 作为标题
              time: formattedTime,
              change: changeStr,
          ...
          <div className='bg-[#f7f8fb] rounded-xl py-6 px-10 mb-8 flex items-center justify-between'>
            ...
            <div className='flex flex-col'>
              <div className='flex items-center gap-2 mb-2 text-[14px] text-gray-500 font-medium'>
                <div className='w-1.5 h-1.5 bg-primary' /> 剩余积分
              </div>
            ...
            <div className='flex flex-col'>
              <div className='flex items-center gap-2 mb-2 text-[14px] text-gray-500 font-medium'>
                <div className='w-1.5 h-1.5 bg-primary' /> 充值积分
              </div>
            ...
            <div className='flex flex-col'>
              <div className='flex items-center gap-2 mb-2 text-[14px] text-gray-500 font-medium'>
                <div className='w-1.5 h-1.5 bg-primary' /> 赠送积分
              </div>
            ...
            <div className='flex flex-col'>
              <div className='flex items-center gap-2 mb-2 text-[14px] text-gray-500 font-medium'>
                <div className='w-1.5 h-1.5 bg-primary' /> 消耗积分
              </div>
                ...
                >
                  ...
                  <div className='flex items-center gap-16 pr-4'>
                    ...
                    <div className='flex flex-col gap-1.5 items-end'>
                      ...
                      <span className={`text-[15px] font-bold ${record.change.startsWith('+') ? 'text-green-500' : 'text-gray-800'}`}>
                        {record.change}
                      </span>
                    </div>
                    {/* 剩余积分 */}
