    ...
    const fetchPointsHistory = async () => {
      ...
      try {
        ...
        if (res?.successful && res?.data) {
          ...
          const formattedRecords: PointRecord[] = rawRecords.map(
            (item: any) => {
              ...
              return {
                ...
                title:
                  item.pointsType ||
                  item.changeType ||
                  t("2bNr1yJPkqOHiooJmsKHs"), // 优先用 pointsType 作为标题
                time: formattedTime,
                change: changeStr,
