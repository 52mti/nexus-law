  ...
  return (
    ...
    >
      <div className="flex flex-col items-center pt-8 pb-2 animate-fade-in">
        ...
        <div className="text-[#666cff] font-bold mb-8 flex items-baseline tracking-tight">
        ...
        <Button 
          ...
          className="w-full h-11 bg-[#666cff] hover:bg-[#585ee6] border-none rounded-lg text-[15px] font-medium tracking-wide shadow-md shadow-indigo-500/20"
        >
          返回首页
        </Button>
      </div>
