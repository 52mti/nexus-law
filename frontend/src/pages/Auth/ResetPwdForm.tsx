...
export const ResetPwdForm: React.FC<Props> = ({ onSwitchMode }) => {
  ...
  return (
    <div className="w-full">
      ...
      {currentStep < 2 && (
        <div className="flex justify-between items-baseline mb-6">
          <span className="text-[17px] font-bold text-gray-800">
            {currentStep === 0 ? t('n4jfkyjfn4R28l4CgOpuB') : t('XOParTDKO1_c_dSkz_4FZ')}
          </span>
          <a
      ...
      {currentStep < 2 && <FormErrorMessage errorData={errorData} shakeKey={shakeKey} />}
      ...
      {currentStep === 2 && (
        <div className="flex flex-col items-center justify-center py-6 animate-fade-in">
          ...
          <h2 className="text-xl font-bold text-gray-800 mb-2">{t('zGNuN00eUvBQtsNpgSbDz')}</h2>
          <p className="text-sm text-gray-500 mb-8">{t('khIEfHwICesjJv0O7PTnJ')}</p>

          <Button type="primary" className={buttonStyles} onClick={() => onSwitchMode('pwd_login')}>
